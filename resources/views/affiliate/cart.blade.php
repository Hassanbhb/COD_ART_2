<x-layouts.landingLayout title="COD ART - Cart">
    <x-store.navbar />

    <section class="py-12 bg-gray-50">
        <div class="max-w-7xl px-4 mx-auto">
            <h1 class="text-center font-heading text-3xl text-coolGray-800 font-semibold mb-10">Shopping Cart</h1>
            <div class="bg-white rounded-xl shadow-md p-6 w-full mb-6">
                <div class="overflow-x-auto">
                    {{-- product 1 --}}
                    <div class="flex justify-between">
                        <div class="py-4 px-6 h-32 min-w-fit flex items-center">
                            <div class="flex items-center gap-4">
                                <div class="bg-gray-100 rounded-lg w-36 lg:w-24 h-24 flex items-center justify-center">
                                    <img src="{{ Vite::asset('resources/assets/shopping-cart/product1.png') }}"
                                        alt="">
                                </div>
                                <div>
                                    <h2 class="text-rhino-800">Main Name for Product</h2>
                        ...
                        <div class="py-4 px-6 h-32 flex items-center justify-center">
                            <div
                                class="py-3 px-4 rounded-sm border border-coolGray-200 flex gap-4 items-center bg-white">
                                <div
                ...
                {{-- total --}}
                <div class="py-4 flex flex-wrap gap-2 justify-between items-center border-t">
            ...
            <div class="flex justify-end flex-wrap gap-4">
                <a class="bg-purple-300 py-3 px-4 rounded text-white text-center hover:bg-purple-600 transition duration-200"
                    href="#">Cancel</a>
                <a class="bg-purple-500 py-3 px-4 rounded text-white text-center hover:bg-purple-600 transition duration-200"
                    href="#">Go to Checkout</a>
            </div>
        </div>
    </section>
