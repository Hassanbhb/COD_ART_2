<x-layouts.landingLayout title="COD ART - Thank You">
    <x-store.navbar />
    ...
    <section class="py-44">
        <div class="container px-4 mx-auto">
            ...
            <p class="uppercase text-rhino-300 font-bold text-xs tracking-widest text-center mb-1">SUCCESS</p>
            <h1 class="font-heading text-center text-4xl text-rhino-700 font-semibold mb-6" contenteditable="false">
                Thank you For your purchase</h1>
            <p class="text-center mb-8 text-rhino-300 text-lg max-w-md mx-auto" contenteditable="false">Our team will
                contact you soon</p>
            <div class="flex justify-center">
                <a class="py-3 px-4 bg-purple-500 rounded-sm text-center text-sm font-medium text-white hover:bg-purple-600 transition duration-200"
                    href="{{ route('affiliate.store') }}">
                    Continue Shopping
                </a>
            </div>
        </div>
